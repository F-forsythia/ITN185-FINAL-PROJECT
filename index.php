        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="editStatusInput">
                </div>
                <div class="modal-footer">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#addTaskBtn").click(function () {
                ...
                if (task && due_date) {
                    $.post("add_task.php", { task: task, due_date: due_date }, function (response) {
                        
                        // ⬇️ INSERT console.log RIGHT HERE
                        console.log("Response from add_task.php:", response);
            ...
            $(document).on("click", ".edit-task", function () {
                ...
                $("#editStatusInput").val($(this).data("status"));
            ...
            $("#saveEditTask").click(function () {
                ...
                var status = $("#editStatusInput").val();
                $.post("update_task.php", { id: id, task: task, due_date: due_date, status: status }, function () {
                    $("#editTaskModal").modal("hide");
                    loadTasks();
                });
            });

            $("#editDueDateInput").on("change", function () {
